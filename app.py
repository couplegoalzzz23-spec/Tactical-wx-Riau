...
""", unsafe_allow_html=True)
# =====================================
# 🛰️ SATELLITE & RADAR IMAGERY (REFERENCE ONLY)
# =====================================
st.markdown("---")
...
with col_sat1:
    ...
    st.caption("BMKG Himawari-8 Infrared — Cloud Top Temperature")
    st.image(
        "https://inderaja.bmkg.go.id/IMAGE/HIMA/H08_IR1_Indonesia.png",
        use_container_width=True
    )
    st.caption("🛈 Reference only — not for tactical separation.")

with col_sat2:
    st.markdown("### ☁️ Himawari-8 Visible / Cloud")
    st.caption("BMKG Himawari-8 Visible — Daytime Only")
    st.image(
        "https://inderaja.bmkg.go.id/IMAGE/HIMA/H08_VIS_Indonesia.png",
        use_container_width=True
    )
